...
const all = [client, ...dependents].filter(x => x['is-actually-enrolled'] == 'si')
console.log(all)
export default function EnrolledTo() {
  ...
  return (
    <form method="post" className="enrolled-to" onSubmit={goTo}>
      ...
      <h2 className="section-title">Cobertura actual</h2>
...

      {
        all.map((cover, i) => (
          <div key={i} className='form-section'>
            <p><b>Que tipo de cobertura tiene {cover['first-name']}?</b></p>
